# Выпускная квалификационная работа бакалавра по теме "Разработка учебно-методического материала по развертыванию и эксплуатации моделей машинного обучения"
